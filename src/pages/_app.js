    ...
    return (
      <>
        ...
        <div className="leading-normal">
          <div className="sticky top-0 z-10 h-12 py-2 px-4 flex items-center bg-sky-400 shadow-xl opacity-90 text-pink-500">
          <a href="/"><Image src="/favicon.ico" width="30" height="30" className="rounded sm:mx-auto"></Image></a>
          </div>
          <div className="flex">
